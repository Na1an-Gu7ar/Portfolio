...
import { faBars, faClose, faEnvelope, faHome, faUser, faBriefcase } from '@fortawesome/free-solid-svg-icons'
        ...
        <>
            <div className='nav-bar'>
                ...
                <nav className={showNav ? 'mobile-show' : 'laptop-show'}>
                    ...
                    <NavLink exact="true" activeclassname="active" className="mywork-link" to="/mywork" onClick={() => setShowNav(false)}>
